...
<br>
  <div id="regsection">
  <form ID="myForm" name="index" action="UserQuizDetails.jsp"  onsubmit="return validateForm()" method="post">
  <fieldset>
  ...
  Class.forName("com.mysql.jdbc.Driver");
	...
	System.out.println("select quiz_id from quiz");
...
<select name="quizid">
 <%
 	while(rs.next()){
 		System.out.println("quid id in while loop"+rs.getString(1));
 %>
