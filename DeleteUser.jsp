...
<br>
  <div id="regsection">
  <form ID="myForm" name="index" action="DeleteUser"  onsubmit="return validateForm()" method="post">
  <fieldset>
    <legend><p><b><font size="6" color="#2C4762">Delete User</b></font></p></legend>
  ...
  Class.forName("com.mysql.jdbc.Driver");
	...
	ResultSet rs= stmt.executeQuery("select uname from user");
  %>
<tr>
<td>
