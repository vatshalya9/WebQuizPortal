...
<br>
  <div id="regsection">
  <form ID="myForm" name="index" action="CreateQuiz"  onsubmit="return validateForm()" method="post">
  <fieldset>
    <legend><p><b><font size="6" color="#2C4762">Create Quiz</b></font></p></legend>
...
<td>
<input type="text" id="quizid" name="qid" required>
						</td>
					</tr>
  <tr>
<td>
...
<td>
 <input type="text" id="quizname" name="qname" required>
</td>
</tr>

<tr>
<td><label>Start Time</label></td>
<td><input type="time" id="time" name="st" required></td>
</tr>
<tr>
<td><label>End Time</label></td>
<td><input type="time" id="time" name="et" required></td>
</tr>
<tr>
<td>
 <label >Date </label>
