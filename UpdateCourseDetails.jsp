...
<br>
  <div id="regsection">
  <form ID="myForm" name="index" action="UpdateCourse"  onsubmit="return validateForm()" method="post">
  <fieldset>
    <legend><p><b><font size="6">Update Course</b></font></p></legend>
	 ...
	 try
	  {
		  ...
		  sess.setAttribute("course", new String (courseid));
		  ResultSet rs = stmt.executeQuery("select * from course where course_id='"+courseid+"'");
		  while(rs.next())
		  {
...
<td>
 <input type="text" id="courseid" name="cid"
 value="<%out.println(session.getAttribute("cid"));%>" disabled
required>
</td>
</tr>
<tr>
...
<td>
 <input type="text" id="coursename" name="cname" 
 value="<%out.println(session.getAttribute("cname"));%>" required>
</td>
</tr>
